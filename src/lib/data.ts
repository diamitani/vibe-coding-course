...
export const tracks: Track[] = [
  ...
  {
    slug: 'ten-day-ai',
    title: 'Build with AI: From Zero to Ship',
    description: 'Master the complete AI builder stack: Custom GPTs, automation workflows, AI assistants, and shipping web apps — all through vibe coding. Master Custom GPTs, automation, AI assistants, and web app development — zero code required.',
    ...
    lessons: [
      ...
      },
      {
        ...
        source: 'letsvibeai Original', sourceUrl: '', duration: '15 min',
        difficulty: 'beginner',
